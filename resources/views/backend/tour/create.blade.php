    ...
    <div class="row pt-5">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::open( ['route'=> 'tour.store', 'method' =>'POST', 'data-parsley-validate'=>''] ) !!}
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-4">
                            {{ Form::select('group', $groups , null, ['placeholder' => 'Group Size', 'class' => 'form-control']) }}
                            @error('group')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            {{ Form::select('difficulty', $difficulties , null, ['placeholder' => 'Difficulty Level', 'class' => 'form-control']) }}
                            @error('difficulty')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-4">
                            {{ Form::select('accomodation', $accomodations , null, ['placeholder' => 'Accomodation', 'class' => 'form-control'])}}
                            @error('accomodation')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-4">
                            {{ Form::select('meal', $meals , null, ['placeholder' => 'Meal Plan', 'class' => 'form-control']) }}
                            @error('meal')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-4">
                            {{ Form::select('category', $categories , null, ['placeholder' => 'Category', 'class' => 'form-control'])}}
                            @error('category')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-4">
                            {{ Form::select('region', $regions , null, ['placeholder' => 'Region', 'class' => 'form-control']) }}
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <textarea id="tinymce" name="overview"></textarea>
                        </div>
                    </div>
