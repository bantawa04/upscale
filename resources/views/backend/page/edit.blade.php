    ...
    <div class="row pt-5">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    {!! Form::model($page, ['route' => ['page.update', $page->id], 'method' => 'PUT','data-parsley-validate'=>'']) !!}
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row mt-3">
                        <div class="col-4" id="levelWrapper" >
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="isParent" value="0" {{$page->isParent ? 'checked' : ''}}  onclick="selectPageLevel()">
                                  <label class="form-check-label">Parent</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="isParent" value="1" {{$page->isParent ? '' : 'checked'}} onclick="selectPageLevel()">
                        ...
                        <div class="col-2">            
                            <label>Status</label>                
                            <div class="form-check">                                
                                <input class="form-check-input" type="checkbox"  {{$page->status ? 'checked' : ''}} value="1" name="status">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            {{ Form::textarea('content', null, array("id"=>'tinymce')) }}
                        </div>
                    </div>
...
<script>
    ...
    function selectPageLevel() {
            ...
            if (ele.value == 1) {//is child
                ...
                console.log(document.querySelector('select[name="parentPage"]').value);
            } else {//is parent
