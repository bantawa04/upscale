                    ...
                    <div class="form-group">
                        ...
                        @foreach ($categories as $item)
                            <div class="form-check">
                                <input name="travel_type[]" type="checkbox" class="form-check-input" id="travel-type-{{$loop->iteration}}" value="{{$item->slug}}">
                                <label for="travel-type-{{$loop->iteration}}" class="form-check-label">{{$item->name}}</label>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-7 px-3">
                            <div class="text-dar">
                                    ...
                                    <div class="col-sm-6 my-1">
                                        <span>
                                            <?php foreach (array_fill(0, 3, null) as $i): ?><span
                                                class="fa fa-star text-primary"></span><?php endforeach ?><?php foreach (array_fill(0, 2, null) as $i): ?><span
                                                class="far fa-star"></span><?php endforeach ?>
                                        </span>
                                        <span>4&nbsp;reviews</span>
                                    </div>
                                    <div class="col-sm-6 my-1">
                                ...
                                <div
                                    class="item-action-wrapper d-flex justify-content-between align-items-end mt-4 mb-3">
